import { oneLandpad } from "./module/app.js";
import { landContent } from "./components/landpads.js";
import { paginationButtons } from "./components/pagination.js";

let first = await oneLandpad(1);
let docs = first.docs;

console.log(first)

let body = document.querySelector("#body");
body.innerHTML = await landContent(docs);
...
const funcion = () =>{
    // let elemento = document.querySelector("#pagination")
    changePage(body,oneLandpad,landContent,paginationButtons,maxPag);   
}
funcion();
